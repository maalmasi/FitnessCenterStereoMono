...
import TrainerViewStore from '../stores/TrainerViewStore'
...
@inject(stores => ({
    trainerViewStore: new TrainerViewStore(stores.rootStore)
}))
@observer
class Trainer extends React.Component {
    render() {
        const { searchQuery, isLoading, columns, isDeleting, page, recordsPerPage, displayItems, itemToDeleteName, onUpdate, onCreate, onFind, onDelete, onSearchQueryChange, onRecordsPerPageChange, onSortChange, onPageChange, onConfirmDelete, onCancelDelete } = this.props.trainerViewStore;
        return (
            <React.Fragment>
                <Layout>
