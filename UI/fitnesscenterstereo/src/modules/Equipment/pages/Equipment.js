...
import EquipmentViewStore from '../stores/EquipmentViewStore'
...
@inject(stores => ({
    equipmentViewStore: new EquipmentViewStore(stores.rootStore)
}))
@observer
class Equipment extends React.Component {
    render() {
        const { searchQuery, isLoading, columns, isDeleting, page, recordsPerPage, displayItems, itemToDeleteName, onUpdate, onCreate, onFind, onDelete, onSearchQueryChange, onRecordsPerPageChange, onSortChange, onPageChange, onConfirmDelete, onCancelDelete } = this.props.equipmentViewStore;
        return (
            <React.Fragment>
                <Layout>
