...
@inject(stores => ({
    scheduleViewStore: new ScheduleViewStore(stores.rootStore)
}))
@observer
class Schedule extends React.Component {
    render() {
        const { searchQuery, isLoading, columns, isDeleting, page, recordsPerPage, displayItems, itemToDeleteName, onUpdate, onCreate, onFind, onDelete, onSearchQueryChange, onRecordsPerPageChange, onSortChange, onPageChange, onConfirmDelete, onCancelDelete } = this.props.scheduleViewStore;
        return (
            <React.Fragment>
                <Layout>
