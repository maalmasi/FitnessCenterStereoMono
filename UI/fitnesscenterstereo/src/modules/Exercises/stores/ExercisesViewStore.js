...
class ExercisesViewStore {
    ...
    columns = [
        ...
        { title: "Body Part Type ID", field: "bodyparttypeid" },
        { title: "Complexity Level Type ID", field: "complexityleveltypeid" }
    ];
    displayItems;
    ...
    @action.bound onCreate() {
        this.routerStore.goTo("exercisescreate");
    };

    @action.bound onUpdate(id) {
        this.routerStore.goTo("exercisesedit", { id: id });
    }
...
export default ExercisesViewStore;